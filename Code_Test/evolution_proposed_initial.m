...
function [u localForce]= evolution_proposed_initial(Img,u,epsilon,Ksigma,KONE,KI,KI2,mu,nu,lambda1,lambda2,timestep,alf)
u=NeumannBound(u);
...
u = u+timestep*(L+P+A);
pro1=normpdf(Img,u1,sqrt(sigma1));
pro2=normpdf(Img,u2,sqrt(sigma2));
return;
